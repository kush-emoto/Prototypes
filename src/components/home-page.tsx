  ...
  return (
    <div className="design-home">
      <section className="dh-hero">
        {content.hero.mediaType === "video" ? <video src={content.hero.mediaUrl} autoPlay muted loop playsInline /> : <img src={content.hero.mediaUrl} alt="EMotorad campaign"/>}
        <div className="dh-overlay" />
        <div className="dh-hero-copy">
          <small>{content.hero.eyebrow}</small>
          <h1>{content.hero.title}</h1>
          <p>{content.hero.subtitle}</p>
          <div className="dh-actions"><Link href={content.hero.ctaHref} className="pill white">{content.hero.ctaLabel}</Link><Link href="/test-ride" className="pill ghost">Book test ride</Link></div>
        </div>
      ...
      <section className="dh-offerings" hidden={!content.enabledSections.products}>
      ...
      <section className="dh-real-india" hidden={!content.enabledSections.intro}>
        <img src="/real-india.jpg" alt="An EMotorad rider in India"/>
        <div><h2>{content.intro.title}</h2><p>{content.intro.body}</p><Link className="pill white" href="/bikes">See how they work →</Link></div>
      </section>

      <section className="dh-explainer" hidden={!content.enabledSections.intro}>
      ...
      <section className="dh-honest" hidden={!content.enabledSections.benefits}>
      ...
      <section className="dh-savings" hidden={!content.enabledSections.benefits}>
      ...
      <section className="dh-government" hidden={!content.enabledSections.newsletter}><div><h2>Partnership With The<br/>Government</h2><p>In partnership with Kuppam Development Authority, EMotorad deployed 10,000+ e-cycles to improve last-mile connectivity and empower students with sustainable mobility. A meaningful step towards building a cleaner, greener, and healthier future.</p><Link className="pill white" href="#impact">Explore Our Impact →</Link></div><img src="/government-ride.jpg" alt="EMotorad government partnership ride"/></section>

      <section className="dh-final-cta" hidden={!content.enabledSections.newsletter}><video src="/homepage-hero.mp4" autoPlay muted loop playsInline/><div><h2>Come, join the Electric Revolution</h2><p>Try an e-cycle for free. No strings attached. Just show up and ride.</p><Link className="pill white" href="/test-ride">Book free test drive</Link><a className="pill ghost" href="https://wa.me/">Talk on Whatsapp</a></div></section>
    </div>
  );
}
